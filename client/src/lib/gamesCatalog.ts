...
export const GAMES: GameDef[] = [
  ...
  { id: 'seaverse', name: 'SeaVerse: Ocean Guardian', category: 'wildlife', description: 'Protect and restore our oceans. Complete missions to save marine life, stop pollution, and learn about ocean conservation.', difficulty: 'Medium', points: 100, icon: '🌊', image: '/api/image/360_F_819000674_C4KBdZyevZiKOZUXUqDnx7Vq1Hjskq3g.jpg', externalUrl: 'https://meek-haupia-394af9.netlify.app/' },
